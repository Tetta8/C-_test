...
void compare(const Date& day){
    ...
    cout << "day = " << day << endl;
    cout << "day2 = " << day2 << endl;
    cout << "day - day2 = " << (day - day2) << endl;
    cout << "day2 - day = " << (day2 - day) << endl;
    cout << "day == day2 = " << (day == day2) << endl;
    cout << "day != day2 = " << (day != day2) << endl;
    cout << "day > day2 = " << (day > day2) << endl;
    cout << "day >= day2 = " << (day >= day2) << endl;
