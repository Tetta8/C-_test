...
int main(){
    Person Shiori1("Ms.Shiori");
    Shiori1.SetAge(20);
    Shiori1.SetPhoneNum("222-3333-4444");

    Person Shiori2("TeacherShiori", 30, "001-1111-2222");
    
    Person Shiori3(Shiori2);
    Shiori3.SetName("BrotherShiori");
    Shiori3.SetAge(24);

    Person *p[] = {&Shiori1, &Shiori2, &Shiori3};

    for(int i = 0; i < 3; i++){
        cout << "Name:" << p[i]->GetName() << "Age:" << p[i]->GetAge() << "Phonenum:" << p[i]->GetPhoneNum() << endl;
    }
    return 0;
}